package com.szklimek.base.widget.circleindicator;
...
public class CircleIndicator extends LinearLayout {
    ...
    private int mAnimatorResId = R.animator.widget_circle_indicator_scale_anim;
    private int mAnimatorReverseResId = 0;
    private int mIndicatorBackgroundResId = R.drawable.shape_pager_indicator_white;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.shape_pager_indicator_white;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mAnimatorResId = typedArray.getResourceId(R.styleable.CircleIndicator_ci_animator,
                R.animator.widget_circle_indicator_scale_anim);
        ...
        mIndicatorBackgroundResId =
                typedArray.getResourceId(R.styleable.CircleIndicator_ci_drawable,
                        R.drawable.shape_pager_indicator_white);
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.widget_circle_indicator_scale_anim, 0, R.drawable.shape_pager_indicator_white, R.drawable.shape_pager_indicator_white);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mAnimatorResId = (mAnimatorResId == 0) ? R.animator.widget_circle_indicator_scale_anim : mAnimatorResId;
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.shape_pager_indicator_white
                : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId =
